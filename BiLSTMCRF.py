...
TAGS = ['B-PERSONNEL', 'B-WEATHER', 'B-FOOD', 'B-HYGIENE', 'B-LOCATION', 'B-FURNITURE', 'I-PERSONNEL', 'I-WEATHER', 'I-FOOD', 'I-HYGIENE', 'I-LOCATION', 'I-FURNITURE', 'O']
...
FOOD_DATA = [
    ...
    [('Pohovana', 'B-FOOD'), ('piletina', 'I-FOOD'), ('se', 'O'), ('jede', 'O'), ('u', 'O'), ('cijelom', 'O'), ('svijetu', 'O'), ('.', 'O')],
    [('Lazanje', 'B-FOOD'), ('su', 'O'), ('Garfildova', 'O'), ('omiljena', 'O'), ('hrana', 'O'), ('.', 'O')],
    [('Suši', 'B-FOOD'), ('je', 'O'), ('poznato', 'O'), ('i', 'O'), ('skupo', 'O'), ('jelo', 'O'), ('u', 'O'), ('Japanu', 'O'), ('.', 'O')],
    [('Unagi', 'B-FOOD'), ('je', 'O'), ('morska', 'O'), ('hrana', 'O'), ('koja', 'O'), ('potiče', 'O'), ('iz', 'O'), ('Japana', 'O'), ('.', 'O')],
...
if __name__ == '__main__':
    ...
    # load ner data
    TRAIN_DATA = []
    ner_data = pd.read_csv('ner_serbian.csv', delimiter='|', encoding='utf-8', names=['sentence', 'word', 'label'], skiprows=1)
    ...
    model = tf.keras.layers.Embedding(WORD_COUNT+1, DENSE_EMBEDDING, embeddings_initializer="uniform", input_length=MAX_SENTENCE)(
        input_layer)
